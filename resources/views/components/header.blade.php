    ...
    <div class="header-inner">
        ...
        <div class="header-nav">
            ...
            <button class="theme-toggle" id="themeToggle" type="button" aria-label="Alternar tema">
                {{-- Sol (light mode) --}}
                <svg id="iconSun" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" style="display: none;">
                ...
                {{-- Lua (dark mode) --}}
                <svg id="iconMoon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" style="display: none;">
